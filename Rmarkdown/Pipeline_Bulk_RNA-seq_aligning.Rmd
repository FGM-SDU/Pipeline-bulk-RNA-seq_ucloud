---
title: "Bulk RNA-seq Alignment Pipeline"
...
3. **Run the Script:** Submit the script to the SLURM cluster:
    ...
    **Optional Arguments**
    * **-t:** include Salmon alignment for isoform-level differential gene expression. Include the flag "-t" after the input file.
