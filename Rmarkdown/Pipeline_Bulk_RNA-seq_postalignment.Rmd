...
5. **Bigwig coverage tracks:** generates coverage tracks with bin size 10, RPKM normalized by bamCoverage (Deeptools).
6. **Create Tag Directories:** generates a sample tag directory using Homer for downstream analysis.
7. **Reads Counting:** Count reads mapped to features (e.g., genes) using FeatureCounts (**-p --countReadPairs -t exon**).
